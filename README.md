...
------|-------|-------|----------|----------|-----
**Bootstrap**<br>```framework``` | ★★★★☆ | <p><details><summary>:bookmark:</summary>*– pre-written, open-source CSS that programmers can use (by importing and assigning relevant class/id names to an element), thus not wasting time creating universal styles from scratch.*</details></p> | | | [:information_source:](https://getbootstrap.com/docs/4.5/getting-started/introduction/)
...
**Django**<br>```framework``````python``` | ★★★★☆ | <p><details><summary>:bookmark:</summary>*– a framework for Python & SQL centered around Models-Templates-Views, that easily builds websites, and even includes an admin module for easy data/DB editing.*</details></p> |
...
<p><details><summary>Skill Levels</summary>- ☆☆☆☆☆: aware of, want to learn<br>- ★☆☆☆☆: learned in lesson<br>- ★★☆☆☆: exercise practice<br>- ★★★☆☆: used for a big project<br>- ★★★★☆: commonly used, utilized in many projects<br>- ★★★★★: extremely confident, advanced level</details></p>
