...
**Object-Oriented Programming**<br>```OOP``` ```paradigm``` | ★☆☆☆☆ | <p><details><summary>:bookmark:</summary>*– aa programming paradigm that relies on Classes and internal attributes(features) & methods (behaviors), rather than that of procedural programming, which relies on blocks of code inside functions.*</details></p> |
